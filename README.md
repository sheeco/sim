...
> *** 与 [ 2.2.0 ]( 0dd0e561bf88035d1cfc557e2083dfa602ab9d43 ) 合并 ***

> *** 得到 [ 3.4.5 ]( c4335ddba90278c908b2629c014dde90f6c7db16 ) ***
...
- RFCT：整理 `main.cpp` 中的调用层次，以便更方便的更改主函数入口，提取出新的函数 `RunSimulation()`；
- RFCT：将包含仿真程序主函数入口的文件 `main.cpp` 重命名为 `Run.cpp`；
- MNT：整理 `Global.h` 中的宏定义和命名空间引用；
...
> *** 与 [ 3.4.5 ]( c4335ddba90278c908b2629c014dde90f6c7db16 ) 合并 ***

> *** 得到 [ 3.5.1 ]( 169dcb4d55408936ef0f88e45e03f931bf81dbd0 ) ***

> *** 以下为 dataparser 分支下的更改 ***
　
